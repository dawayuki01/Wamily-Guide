...
const NEW_CURATIONS = [
  ...
  { name: '地球の歩き方 aruco ロンドン 2024〜2025', type: 'Book', country: 'ロンドン', url: 'https://amzn.asia/d/056Hhtii', desc: '定番ガイド「aruco」シリーズのロンドン編。最新の見どころと旅情報を網羅した1冊。' },
  { name: 'Charlie｜イギリス旅案内人', type: 'Blog', country: 'ロンドン', url: 'https://note.com/cute_london', desc: 'ロンドン在住14年の旅案内人。観光客が知らない"通の旅"を、穴場・無料スポット・スイーツの切り口で発信。' },
  ...
  { name: 'Paris Magazine', type: 'Blog', country: 'パリ', url: 'https://paris-mag.com/', desc: 'パリ在住者が運営する観光マガジン。アート・食・買い物・季節イベントまで網羅的に紹介。' },
  { name: 'el BLANCO', type: 'Blog', country: 'パリ', url: 'https://www.encanta-europa10.com/', desc: '"暮らすような旅"の魅力を、写真と臨場感で綴るパリ・南仏・スペインの旅ブログ。' },
  ...
  { name: 'BANGKOK GIRLS NOTE', type: 'Blog', country: 'バンコク', url: 'https://www.bangkok-pukuko.com/', desc: 'タイ・バンコク専門メディア。観光・グルメ・暮らし・子育てまで、ぷくこさんが現地のリアルを発信。' },
  ...
  { name: '地球の歩き方 aruco 香港 2025〜2026', type: 'Book', country: '香港', url: 'https://amzn.asia/d/0ijHA5nf', desc: '定番ガイド「aruco」シリーズの香港編。最新の見どころと旅情報を網羅した1冊。' },
  { name: '香港の歴史と地政学（書名要確認）', type: 'Book', country: '香港', url: 'https://amzn.asia/d/0h8Rce2X', desc: '香港の歴史と地政学を一冊でまとめた書籍。旅をもっと深く楽しむための背景知識に。※書名はNotionで確認・修正してください。' },

  // マニラ
  { name: 'Yuko_ih_bkk.ph', type: 'Blog', country: 'マニラ', url: 'https://note.com/yuko_ih_bkk', desc: 'タイ6年・フィリピン1年の駐在妻が発信する、海外子育て・旅行・駐在生活のリアルなnote。' },
  ...
  { name: 'Taiwan Scene', type: 'Blog', country: '台湾', url: 'https://taiwan-scene.com/', desc: '台湾のカフェ・アート・地方・文化を扱うトラベルマガジン。"台湾aesthetic"の感度が高め。雰囲気から味わいたい人に。' },
  ...
  { name: 'Mommy Poppins Los Angeles', type: 'Blog', country: 'LA', url: 'https://mommypoppins.com/los-angeles', desc: 'LAの子連れ向け情報を集めたファミリーメディア。公園・無料スポット・週末イベントの参考に。' },

  // シンガポール
  { name: 'The Smart Local Singapore', type: 'Blog', country: 'シンガポール', url: 'https://thesmartlocal.com/', desc: 'シンガポールのローカルが見るメディア。カフェ・公園・モール・新スポットなど、"今シンガポール人がどこに行っているか"が見えてきそう。' },
  ...
  { name: 'SingaLife', type: 'Blog', country: 'シンガポール', url: 'https://singalife.com', desc: '在シンガポールの日本人向けメディア。生活者目線の情報が日々更新され、現地のリアルが届きやすい。' },
  ...
  { name: 'allhawaii（ハワイ州観光局公式）', type: 'Blog', country: 'ハワイ', url: 'https://www.allhawaii.jp/', desc: 'ハワイ州観光局の日本語公式サイト。公式ながら実用的で、旅の準備から現地情報まで参考になる。' },

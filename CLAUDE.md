...
| community.yml（週次） | 毎週月曜 10:00 JST | GA4レポート + Notionダッシュボード更新 |
...
| 6 | Wamily AI チーム組成 | ✅ Phase 1 完了（パトロール・コンテンツ・メルマガ）✅ Phase 2 完了（コミュニティ部 user/host）Phase 3 設計完了（`docs/ai-teams-phase3-spec.md`） |
| 7 | サイト公開 | 上記完了後 |
...
| 新しい国を追加したい | `countries.json` に draft で追加 → `scripts/add-country.js` 実行 |

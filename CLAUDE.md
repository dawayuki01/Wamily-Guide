...
- WAMILY_DESIGN_SPEC.md のトーン・世界観を徹底

### 2. 旅のバトン の再設計
- 現状の旅のバトンセクションを見直し
- 「みんなで作るガイドブック」「緩やかなコミュニティ」という方向性
- ユーザーが気軽に・楽しく関われる仕組みにする
- 今の内容より解像度を上げて、具体的なUXを設計する
- どこまで機能させるか、必要性も含めて判断する

### 3. メルマガ
- Wamily の旅情報・更新をメールで届ける仕組み

### 4. 各国 Google マップ + キュレーションをリッチ化して公開
- 地図の充実
- キュレーション（YouTube / Instagram / ブログ）コンテンツの拡充

### 5. Wamily プラットフォーム × AI チーム組成
- サイト全体をプラットフォームとして進化させる
- AI を活用したチーム組成・運営の仕組みを構築

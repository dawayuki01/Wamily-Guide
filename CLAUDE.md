...
### 1. トップページのデザイン大幅アップデート ← いまここ
- サイトの「顔」として最高のクオリティに仕上げる
- ガイドブック・コンセプト・つながるページで作ったトーンに統一
- WAMILY_DESIGN_SPEC.md の世界観を徹底
- **これが完了 → サイトデザインのフィックス**

### 2. 全ページ動作確認
- トップ完成後、全ページの挙動・遷移・フォーム送信をまとめてテスト
- お問い合わせ / ホスト相談 / ホスト応募 / 旅のバトン — 全フォーム動作確認

### 3. メルマガ
- Wamily の旅情報・更新をメールで届ける仕組み

### 4. 各国 Google マップ + キュレーションをリッチ化
- 地図の充実（スポット追加）
